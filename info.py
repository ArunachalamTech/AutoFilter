...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://akmonsterprogrammer:S.Aruna1155182089@dora.kucvu.mongodb.net/?retryWrites=true&w=majority&appName=Dora")
DATABASE_NAME = environ.get('DATABASE_NAME', "Dora")
