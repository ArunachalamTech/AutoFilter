    ...
    async def give_filter(client, message):
        if message.chat.id != SUPPORT_CHAT_ID:
            ...
            if total_results == 0:
                ...
                reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🔍 ᴊᴏɪɴ ᴀɴᴅ ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ 🔎", url=MGL)]]))
else:   
...
if PM_SEARCH == True:
    ...
    async def pm_text(bot, message):
        ...
        await message.reply_text(
             ...
             reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=MGL)]])
        )
...
async def next_page(bot, query):
    ...
    if settings['button']:
        ...
        btn.insert(0, [
            InlineKeyboardButton("𝚆𝚎𝚎𝚔𝚕𝚢 𝚁𝚎𝚕𝚎𝚊𝚜𝚎𝚍 𝙼𝚘𝚟𝚒𝚎𝚜", url=MCL),
            InlineKeyboardButton('❤️𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩 𝐂𝐡𝐚𝐧𝐧𝐞𝐥', url=WCL)
        ])
    else:
        btn = []
        btn.insert(0, 
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("🔍 ꜱᴇᴀʀᴄʜ ʜᴇʀᴇ 🔎", url=MGL)
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
                ...
                buttons = [[
                    InlineKeyboardButton('💻 Wᴀᴛᴄʜ & Fᴀꜱᴛ Dᴏᴡɴʟᴏᴀᴅ', url=lazy_stream)
                            ...
                            InlineKeyboardButton('💰 ɢᴇᴛ ғʀᴇᴇ/ᴘᴀɪᴅ sᴜʙsᴄʀɪᴘᴛɪᴏɴ 💰', callback_data='buy_premium')
                                ...
                                InlineKeyboardButton('Mᴏᴠɪᴇ🔎Gʀᴏᴜᴘ', url=MGL),
                                InlineKeyboardButton('Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ', url=MICL)
                            ],[
                                InlineKeyboardButton('𝚆𝚎𝚎𝚔𝚕𝚢 𝚁𝚎𝚕𝚎𝚊𝚜𝚎𝚍',url=MCL),
                                InlineKeyboardButton('❤️𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩 𝐂𝐡𝐚𝐧𝐧𝐞𝐥', url=WCL)
                            ]]
            else:
    ...
    # don't change anything without contacting me @I_Am_MrAK
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('🫨 ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ ✨', url=MGL)
                ],[
                    ...
                    InlineKeyboardButton('ᴡᴇᴇᴋʟʏ ʀᴇʟᴇᴀsᴇᴅ',url=MCL),
                    InlineKeyboardButton('❤️ᴡʜᴀᴛsᴀᴘᴘ ᴄʜᴀɴɴᴇʟ', url=WCL)
                    ]]
    ...
    # Thanks to @I_Am_MrAK for fixing this 
        ...
        buttons = [[
            ...
            InlineKeyboardButton('𝐁𝐀𝐂𝐊𝐔𝐏 𝐌𝐀𝐈𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url=BMICL),
            InlineKeyboardButton('𝐁𝐀𝐂𝐊𝐔𝐏 𝐀𝐍𝐈𝐌𝐄 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url=BACL)
        ],[
            InlineKeyboardButton('𝐁𝐀𝐂𝐊𝐔𝐏 𝐌𝐎𝐕𝐈𝐄 𝐆𝐑𝐎𝐔𝐏', url=BMGL),
            InlineKeyboardButton('𝐁𝐀𝐂𝐊𝐔𝐏 𝐌𝐎𝐕𝐈𝐄 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url=BMCL)  
        ],[
            InlineKeyboardButton('𝐓𝐀𝐌𝐈𝐋 𝐒𝐄𝐑𝐈𝐀𝐋𝐒', url=TSCL)
        ],[
            InlineKeyboardButton('𝐁𝐀𝐂𝐊𝐔𝐏 𝐌𝐎𝐕𝐈𝐄 𝐁𝐎𝐓', url=BMB),
            InlineKeyboardButton('𝐁𝐎𝐓𝐒 𝐔𝐏𝐃𝐀𝐓𝐄', url=MRAKBOTS)
        ],[
            InlineKeyboardButton('⇇ ʙᴀᴄᴋ', callback_data='start'),
            InlineKeyboardButton('ꜱᴜᴘᴘᴏʀᴛ 👮', url=USERNAME)
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
...
async def auto_filter(client, msg, spoll=False):
    ...
    if not spoll:
            ...
            if not files:
                ...
                if settings["spell_check"]:
                  #  st=await message.reply_sticker(sticker="CAACAgQAAxkBAAEq2R9mipkiW9ACyj7oQXznwKTPHqNCXQACkBUAA3mRUZGx4GwLX9XCHgQ")
                    searching_spell = await client.send_animation(
                    chat_id=chat_id,
                    animation=random.choice(SEARCHGIF),
                    caption=f'🔎 ᴄʜᴇᴄᴋɪɴɢ ʏᴏᴜʀ sᴘᴇʟʟɪɴɢ...'
                    )
                    is_misspelled = await ai_spell_check(chat_id = message.chat.id,wrong_name=search)
                    if is_misspelled:
                    #    await searching_spell.edit(f'<b>Ai Suggested <code>{is_misspelled}</code>\nSo Im Searching for <code>{is_misspelled}</code></b>')
                        await asyncio.sleep(2)
                        message.text = is_misspelled
                   #     await st.delete()
                        await searching_spell.delete()
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(f'Seaching for {search} 🔎', url=MGL)]]) 
        )
        settings = await get_settings(message.chat.id)
...
async def advantage_spell_chok(client, msg):
    ...
    try:
        ...
        if not g_s:
            ...
            button = [[
                       InlineKeyboardButton("📝 ʀᴇǫᴜᴇꜱᴛ ʜᴇʀᴇ", url=MGL)
            ]]
            if NO_RESULTS_MSG:
